                        ...
                        mAuth.createUserWithEmailAndPassword(adm,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful())
                                {
                                    ...
                                    myUsersDatabase = FirebaseDatabase.getInstance().getReference().child("Farmer").child("Users").child(userId);
                                    ...
                                    pd.dismiss();
                                    mAuth.signOut();
                                    startActivity(new Intent(FarmerRegisterActivity.this,FarmerLoginActivity.class));
                                    finish();
                                }else {
                                    pd.dismiss();
